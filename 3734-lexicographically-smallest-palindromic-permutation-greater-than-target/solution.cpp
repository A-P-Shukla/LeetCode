...
public:
    string smallestPalindrome(string s, string target) {
        ...
        // Determine max prefix length of target[0..half-1] that can be matched
        ...
        // Precompute available counts at each position k
        ...
        // Try divergence from k = min(half - 1, max_match) down to 0
