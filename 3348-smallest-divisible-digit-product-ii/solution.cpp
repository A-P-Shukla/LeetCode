...
public:
    string stringSequence(string num, long long t) {
        ...
        // Case 1: Check if num itself is valid (no zero and product divisible by t)
        if (fz == -1) {
        ...
        // Case 2: Match a prefix of length i, change digit at index i, and minimize suffix
