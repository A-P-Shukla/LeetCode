        ...
        while (!q.empty()) {
            ...
            for (auto& d : dirs) {
                ...
                if (nr >= 0 && nr < m && nc >= 0 && nc < n) {
                    ...
                    // Pruning: Only proceed if this reach achieves strictly more energy
